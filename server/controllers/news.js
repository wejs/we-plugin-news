...
module.exports = {
  ...
  findOne(req, res, next) {
    ...
    // check if can access news unpublished
  ...
  create(req, res) {
    ...
    if (req.method === 'POST') {
      ...
      // send the admin or editor to admin create news page:
  ...
  edit(req, res) {
    ...
    if (req.we.config.updateMethods.indexOf(req.method) >-1) {
      ...
      res.redirect('/admin/#/news/'+record.id);
    }
  },
  ...
  delete(req, res) {
    ...
    res.locals.deleteMsg = 'news.delete.confirm.msg';
